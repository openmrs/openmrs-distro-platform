...
COPY --from=dev /app/target/distro/web/openmrs.war /openmrs/distribution/openmrs_core/

COPY --from=dev /app/target/distro/web/openmrs-distro.properties /openmrs/distribution

COPY --from=dev /app/target/distro/web/modules /openmrs/distribution/openmrs_modules
COPY --from=dev /app/target/distro/web/owa /openmrs/distribution/openmrs_owas
